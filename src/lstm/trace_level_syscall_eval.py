...
if __name__ == "__main__":
    ...
    output_val = r"data\processed\php_cwe_434\trace_level_syscall_validation_scores.csv"
    output_test = r"data\processed\php_cwe_434\trace_level_syscall_test_scores.csv"
    output_summary = r"data\processed\php_cwe_434\trace_level_syscall_eval_summary.csv"
