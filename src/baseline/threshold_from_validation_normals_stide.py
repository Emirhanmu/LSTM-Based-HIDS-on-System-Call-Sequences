...
if __name__ == "__main__":
    ...
    val_file = base_dir / "trace_level_stide_validation_scores.csv"
    test_file = base_dir / "trace_level_stide_test_scores.csv"
    output_file = base_dir / "trace_level_stide_validation_normal_thresholds.csv"
